...
<title>trader manage</title>
	...
	function deleteFun(id) {
		...
		parent.$.messager.confirm('ask', 'Are you sure to delete the trader？', function(b) {
			if (b) {
...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',fit:true,border:false" title="trader list">
