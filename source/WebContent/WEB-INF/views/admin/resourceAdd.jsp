...
<div style="padding: 3px;">
	<form id="resourceAddForm" method="post">
		<table class="grid">
			<tr>
				<td>Name</td>
				<td><input name="name" type="text" placeholder="please input resource name" class="easyui-validatebox span2" data-options="required:true" ></td>
				<td>Type</td>
			...
			<tr>
				<td>URL</td>
				<td><input name="url" type="text" placeholder="please input resource url" class="easyui-validatebox span2" data-options="width:140,height:29" ></td>
				<td>Sequence</td>
