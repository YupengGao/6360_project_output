...
<div id="roleGrantLayout" class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'west'" title="System Resource" style="width: 300px; padding: 1px;">
	...
	<div data-options="region:'center'" title="" style="overflow: hidden; padding: 10px;">
		<div>
			...
			<br /> <br />
			<button class="btn btn-warning" onclick="checkInverse();">invert selection</button>
			<br /> <br />
			<button class="btn btn-inverse" onclick="uncheckAll();">cancel</button>
		</div>
	</div>
</div>